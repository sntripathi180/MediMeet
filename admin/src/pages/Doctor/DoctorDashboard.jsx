...
const DoctorDashboard = () => {
  const { getDashData, dashData, dToken, setDashData,completeAppointment,cancelAppointment } =
            ...
            {dashData.latestAppointments.map((item,index) =>(
              <div className="flex items-center px-6 py-3 gap-3 hover:bg-gray-100" key={index}>
                ...
                <div className="flex-1 text-sm">
                 ...
                 {
                             item.cancelled ? <p className="text-red-400 text-xs font-medium">Cancelled</p>:item.isCompleted ?<p className="text-green-400 text-xs font-medium">Completed</p>: <div className="flex">
